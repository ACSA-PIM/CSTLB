...
config=/root/codes/Victima/sniper/config/UniNDP/CPU-HBM/baseline_CPU_8core_cuckoo_potm_channel.cfg
...
run_and_notify() {
    ...
    (cd "$dir" && $sniper -c $config -s stop-by-icount:4000000000 --genstats -g --perf_model/ptw/enabled=false -g --perf_model/ptw/virtualized=true --traces=${trace},${trace},${trace},${trace},${trace},${trace},${trace},${trace} && echo "$dir completed") &
}
