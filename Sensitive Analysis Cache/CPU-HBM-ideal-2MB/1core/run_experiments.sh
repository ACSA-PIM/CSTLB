...
run_and_notify() {
    ...
    (cd "$dir" && $sniper -c $config -s stop-by-icount:500000000 --genstats -g --perf_model/l3_cache/cache_size=2048  --traces=/root/codes/Victima/traces/$dir.sift && echo "$dir completed") &
}
